...
def get_oauth_string(oauth2_info):
    access_token, expires_in = refresh_authorization(oauth2_info['google_client_id'], oauth2_info['google_client_secret'], oauth2_info['google_refresh_token'])
    auth_string = generate_oauth2_string(oauth2_info['email_address'], access_token, as_base64=True)
    return auth_string


def get_oauth2_info(oauth2_file = 'oauth2.json'):
